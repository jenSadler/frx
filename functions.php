...
$sep  = "";
  ...
  if ( is_single() ) {
    ...
    if( !empty( $get_last_category ) ) {
      ...
      echo '<li class="item item-current"><span><a href="#mainTitle">'. get_the_title() .'</a></span></li>';
    ...
    if( is_tax() ) {
      ...
      echo '<li class="item item-current"><span><a href="#mainTitle">'. $custom_tax_name .'</a></span></li>';
      ...
      echo '<li class="item item-current"><span><a href="#mainTitle">'. single_cat_title( '', false ) .'</a></span></li>';
      ...
      echo '<li class="item-current item"><span><a href="#mainTitle">'. $get_term_name .'</a></span></li>';
      ...
      // Day display
      echo '<li class="item-current item"><span>'. get_the_time('jS') .' '. get_the_time('M'). ' Archives</span></li>';
      ...
      // Month Display
      echo '<li class="item-month item-current item"><span>'. get_the_time('M') .' Archives</span></li>';

    } else if ( is_year() ) {

      // Year Display
      echo '<li class="item-year item-current item"><span>'. get_the_time('Y') .' Archives</span></li>';
      ...
      // Display author name
      echo '<li class="item-current item"><span><a href="#mainTitle">'. 'Author: '. $userdata->display_name . '</a></span></li>';

    } else {

      echo '<li class="item item-current"><span><a href="#mainTitle">'. post_type_archive_title() .'</a></span></li>';
