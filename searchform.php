<form action="/" method="get" autocomplete="off" class="input-group mb-3">
  <div class="input-group">
    <input type="search" class=" w-100 form-control border-0" placeholder="Search" aria-label="search nico" name="s" id="keyword" value="<?php echo esc_attr( get_search_query() ); ?>">
